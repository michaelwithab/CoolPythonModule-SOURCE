...
setuptools.setup(
    name="coolmodule-MICHAELWITHAB2", # Put your username here!
    version="0.0.1", # The version of your package!
    author="MICHAELWITHAB2", # Your name here!
    author_email="bubbaboy789@protonmail.com", # Your e-mail here!
    description="a cool module", # A short description here!
